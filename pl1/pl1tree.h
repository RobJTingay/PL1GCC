/*
    GCC PL/I Compiler definitions for interfacing to pl1tree.c
   ...
   GCC PL/I is free software; you can redistribute it and/or modify it under
    ...
    Based on treelang/treetree.h Tim Josling 1999, 2000, 2001.
...
void pl1_init_decl_processing (void);
void pl1_finish (void);
bool pl1_init (void);
unsigned int pl1_init_options (unsigned int, const char **);
int pl1_handle_option (size_t scode, const char *arg, int value);
void pl1_parse_file (int debug_flag);
