/*
    ...
    GCC PL/I Compiler back end interface (pl1tree.c)
    ...
    Based on treelang/treetree.c by Tim Josling 1999, 2000, 2001.
...
#define LANG_HOOKS_PARSE_FILE pl1_parse_file
...
#define LANG_HOOKS_INIT pl1_init
#undef LANG_HOOKS_NAME
#define LANG_HOOKS_NAME	"GNU PL/I"
#undef LANG_HOOKS_FINISH
#define LANG_HOOKS_FINISH		pl1_finish
#undef LANG_HOOKS_INIT_OPTIONS
#define LANG_HOOKS_INIT_OPTIONS  pl1_init_options
#undef LANG_HOOKS_HANDLE_OPTION
#define LANG_HOOKS_HANDLE_OPTION pl1_handle_option
